...
{
	string fingerNamesTemp[] = {"Thumb", "Index", "Middle", "Ring", "Pinky"};
	string boneNamesTemp[] = {"Metacarpal", "Proximal", "Middle", "Distal"};
	string stateNamesTemp[] = {"STATE_INVALID", "STATE_START", "STATE_UPDATE", "STATE_END"};
	
	copy(begin(fingerNamesTemp),end(fingerNamesTemp),begin(fingerNames));
	copy(begin(boneNamesTemp),end(boneNamesTemp),begin(boneNames));
	copy(begin(stateNamesTemp),end(stateNamesTemp),begin(stateNames));
